...
document.querySelector('#massa').oninput = masCount;
...
function checedSystem(){
    var dis = document.querySelector('#massa').disabled;
    if (dis) {
        document.querySelector('#massa').disabled = false;
        ...
        document.querySelector('#massa').disabled = true;
